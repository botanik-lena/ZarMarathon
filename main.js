...
//Поместить весь ход игры в класс Game не получилось. Все функции становятся методами, ссылаются друг на друга, а строки которые написаны вне функциий вообще не понятно куда девать. Плюс в createPlayers идет возврат игроков, после этого код становится недосягаемым((
